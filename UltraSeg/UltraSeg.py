...
try:
  ...
  # slicer.util.messageBox("UltraSeg module requires ParallelProcessing extension. Install it and restart Slicer.")
  msg = qt.QMessageBox()
  msg.setIcon(qt.QMessageBox.Information)
  msg.setText("UltraSeg module requires ParallelProcessing extension. Please install it from the Extension Manager\
               and restart Slicer.\n")
  msg.setWindowTitle("UltraSeg module")
